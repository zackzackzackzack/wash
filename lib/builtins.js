...
builtins.prototype.lower = function(str) { 
    if(_.isString(str)) {
        ...
        throw new Error('unsupported string type: ' + typeof str);
    }
};
...
builtins.prototype.join = function(x, delim) {
    if(!_.isString(delim)) {
        throw new Error('unsupported delimiter type: ' + typeof delim);
    }
    ...
    if(_.isArray(x)) {
        ...
        throw new Error('unsupported collection type: ' + typeof x);
    }
};
