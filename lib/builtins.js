...
builtins.prototype.lower = function(str) { 
    if(_.isString(str)) {
        ...
        throw new errors.InvalidTypeError('unsupported string type: ' + typeof str);
    }
};
...
builtins.prototype.join = function(x, delim) {
    if(!_.isString(delim)) {
        throw new errors.InvalidTypeError('unsupported delimiter type: ' + typeof delim);
    }
    ...
    if(_.isArray(x)) {
        ...
        throw new errors.InvalidTypeError('unsupported collection type: ' + typeof x);
    }
};
...
builtins.prototype.getAt = function(x, idx) {
    if(!_.isNumber(idx)) {
        throw new errors.InvalidTypeError('index must be a number: ' + typeof idx);
    }
