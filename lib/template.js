...
Renderer.prototype._evalTokens = function(tokens) {
    var outs = [];
...
Renderer.prototype._parseForTag = function(tokens) {
    var outs = [];
...
Renderer.prototype._parseTag = function(tokens) {
    if(tokens.length) {
        var outs = [];
...
Renderer.prototype.render = function(context) {
    ...
    var functionBody = this.compiledCode.join('');
    //console.log(functionBody);

    var func = new Function('__ctx', '__builtin', functionBody)

    return func(context, builtins);
};
