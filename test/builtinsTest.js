...
describe('Builtins', function () {
    ...
    describe('containsIntersect', function () {
        expect('{{ containsIntersect(arr, arr) }}', 'true');
        expect('{{ containsIntersect(arr, iarr) }}', 'false');
    });

    describe('intersectLen', function () {
        expect('{{ intersectLen(arr, arr) }}', '5');
        expect('{{ intersectLen(arr, iarr) }}', '0');
    });
